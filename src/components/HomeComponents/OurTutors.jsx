...
const OurTutors = () => {
  const tutors = [
    ...
    },
    {
      ...
      designation: 'Instructor',
      image: sabahatImage,
      linkedin: 'https://www.linkedin.com/in/sabahat-farooq-%F0%9F%87%B5%F0%9F%87%B8-440a6a1aa/', // Update with actual URL
      bgColor: '#FFD93D'
    },
    {
      id: 4,
    ...
    <section className="tutors-section">
      <div className="container">
        <div className="section-header">
          <h2 className="section-titles-our-tutors">
            Our Expert Tutors
          </h2>
                ...
                <div className="tutor-image-container">
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      e.target.src = 'https://via.placeholder.com/300x400?text=Tutor'; // Fallback image
                    }}
                  />
                </div>
